<p align="center">
  <img src="public/assets/logo/logo-dever.png" alt="FU-DEVER Logo" width="120" />
</p>
...
```mermaid
graph TD
    User["📱 Sinh viên quét QR gửi Form"] -->|JSON API Request| Vercel["⚡ Vercel Serverless Function"]
    Vercel -->|Lưu Trữ Dữ Liệu| Supabase["🗄️ Supabase Postgres DB"]
    Supabase -->|WebSocket Event ~150B| Display["🖥️ Màn Hình Trình Chiếu Gian Hàng"]
    Display -->|100% Render & Physics| GPU["🎮 GPU Máy Tính (Hardware Accelerated)"]
    GPU --> Screen["🏮 60-120 FPS Buttery Smooth Display"]
```
