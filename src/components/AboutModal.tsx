        ...
        <div className="mb-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>Khám phá Website chính thức: <span className="text-[#00f5d4] underline font-mono font-bold">fudever.com</span></span>
            </div>
        ...
        <div className="space-y-1.5 mb-3.5">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-mono">fudever.com</span>
            </div>
